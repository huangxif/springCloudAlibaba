...
CREATE TABLE IF NOT EXISTS  QQ_USER (
    ...
    EMAI   VARCHAR(50) DEFAULT NULL  COMMENT '电子邮箱',
...
CREATE TABLE IF NOT EXISTS  QQ_FRIENDS_TYPE (
    ...
    USER_ID  INT(11)  NOT NULL  COMMENT '用户ID,0为系统默认',
    TYPE_NAME  VARCHAR (64) NOT NULL  COMMENT '分组名称',
    CREATE_TIME datetime NOT NULL COMMENT '添加时间',
    UPDATE_TIME datetime NOT NULL COMMENT '修改时间',
    TYPE_ORDER INT(11) NOT NULL COMMENT '排序',
    IS_SHOW tinyint DEFAULT 1 COMMENT '是否隐藏:0:不展示,1:展示',
    IS_SYS tinyint DEFAULT 1 COMMENT '是否隐藏:0:系统创建,1:用户创建',
    PRIMARY KEY (TYPE_ID),
    KEY FFRIENDS_TYPE_USER_ID_INDEX (USER_ID)
...
CREATE TABLE IF NOT EXISTS  QQ_FRIENDS (
    ...
    FRIEND_TYPE tinyint DEFAULT 1  COMMENT '好友类型：0好友,1群聊',
...
CREATE TABLE IF NOT EXISTS  QQ_FRIEND_CHATTING_RECORDS (
    ...
    GROUP_ID  INT(11) DEFAULT 0  COMMENT '群组ID:0:表示普通消息，其他为群组ID',
...
CREATE TABLE IF NOT EXISTS  QQ_GROUP (
    ...
    GROUP_UPDATE_DATE  dateTime NOT NULL  COMMENT '修改时间',
    PRIMARY KEY (GID)
    ) ENGINE=INNODB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT'群组表';

-- 群组成员表
CREATE TABLE IF NOT EXISTS  QQ_GROUP_USER (
...
-- 添加好友信息表
CREATE TABLE IF NOT EXISTS  QQ_ADD_FRIEND_MESSAGE (
    MESSAGE_ID  INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    USER_ID INT(11) NOT NULL  COMMENT '被添加用户ID',
    FROM_ID INT(11) NOT NULL  COMMENT '添加用户ID',
    ...
    DEAL_WITH tinyint DEFAULT 0 COMMENT '处理结果:0:未处理,1:拒绝，2:同意',
    CREATE_TIME datetime NOT NULL COMMENT '添加时间',
    UPDATE_TIME datetime NOT NULL COMMENT '修改时间',
    PRIMARY KEY (MESSAGE_ID),
    KEY BUSINESS_USER_ID (USER_ID),
    KEY BUSINESS_FROM_ID (FROM_ID)
    ) ENGINE=INNODB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT'添加好友信息表';